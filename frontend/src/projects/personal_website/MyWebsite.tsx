    ...
    <ol className='relative border-s border-rfg/40 pl-2'>
      <li className='flex flex-col mb-10 ms-6'>
        ...
        <p className='mb-1 text-base font-normal text-rfg/80 gap-1'>
          ...
          me. I built it in a way that would be easy to follow while providing
          all the key information about me. The version you see now is what I
          consider to be 60% done. Something that is currently in the works is
          what I have dubbed 'The Agent of Sam'. It is an agentic AI with access
          to a lot of information about, well, me. You will be able to ask it
          questions about me, such as my interests, hobbies, past experience and
          more. It will also be able to answer any questions you have about more
          technical terms on my website, such as the terminology in the NYPD
          Traffic Analysis project. Look forward to meeting to not an AI version
          of me, but what will be more of an AI wikipedia of my life.
        </p>
